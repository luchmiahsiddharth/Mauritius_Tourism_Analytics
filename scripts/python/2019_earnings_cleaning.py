...
raw = pd.read_excel(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\raw\2020 tourist arrivals\Tourist_M_Dec20.xls",
...
earnings_df = earnings_df[(earnings_df["Year"] == "2019") & (earnings_df["Month"] != "Jan-Dec")]
...
earnings_df.to_csv(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\processed\2019_Earnings_Clean.CSV",
    index=False
)
