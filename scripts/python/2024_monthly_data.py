...
raw = pd.read_excel(r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\raw\2024 tourist arrivals\Tourist_M_Dec24_130125.xlsx", sheet_name="Table 2", header=None)
...
tidy.to_csv(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\processed\2024_Tourist_Arrivals_Clean.CSV",
    index=False
)