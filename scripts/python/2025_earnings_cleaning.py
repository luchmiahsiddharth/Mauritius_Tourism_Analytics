...
raw = pd.read_excel(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\raw\2025 tourist arrivals\monthly\Tourist_M_Dec25_120126.xlsx",
...
# FIXED: 2025 file, so filter for 2025
earnings_df = earnings_df[(earnings_df["Year"] == "2025") & (earnings_df["Month"] != "Jan-Dec")]
...
earnings_df.to_csv(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\processed\2025_Earnings_Clean.CSV",
    index=False
)
