...
raw = pd.read_excel(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\raw\2022 tourist arrivals\Tourist_M_Dec 2022_110123.xlsx",
...
earnings_df = earnings_df[(earnings_df["Year"] == "2021") & (earnings_df["Month"] != "Jan-Dec")]
...
earnings_df.to_csv(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\processed\2021_Earnings_Clean.CSV",
    index=False
)
