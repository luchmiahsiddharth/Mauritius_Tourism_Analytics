...
earnings_df = earnings_df[(earnings_df["Year"] == "2018") & (earnings_df["Month"] != "Jan-Dec")]
...
earnings_df.to_csv(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\processed\2018_Earnings_Clean.CSV",
    index=False
)
