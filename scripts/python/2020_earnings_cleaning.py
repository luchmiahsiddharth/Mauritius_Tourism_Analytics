...
raw = pd.read_excel(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\raw\2021 tourist arivals\Tourist_M_Dec21_110122.xlsx",
...
earnings_df = earnings_df[(earnings_df["Year"] == "2020") & (earnings_df["Month"] != "Jan-Dec")]
...
earnings_df.to_csv(
    r"C:\Users\sidlu\Mauritius_Tourism_Analytics\data\processed\2020_Earnings_Clean.CSV",
    index=False
)
